---
name: tgdd-infobox-nganh-hang-hang
description: "Viết, audit và chỉnh sửa Infobox cho trang NGÀNH HÀNG + HÃNG của Thế Giới Di Động như Laptop Asus, Laptop Dell, Điện thoại Samsung, Tai nghe Sony, TV LG hoặc Máy tính bảng Xiaomi. Dùng khi người đọc đã chọn thương hiệu và cần hiểu điểm nổi bật, các dòng sản phẩm thực sự có trong URL danh mục, cách chọn theo nhu cầu, ưu đãi/chính sách tại TGDĐ và FAQ. Không liệt kê sản phẩm ngoài danh mục và không so sánh xếp hạng thương hiệu. Draft không tự bịa URL; internal link bắt buộc được chèn sau bằng content-html-optimizer."
---

# TGDĐ Infobox - Trang Ngành Hàng + Hãng (Type 2)

## Mục tiêu

Người đọc đã chọn thương hiệu và đang tìm dòng sản phẩm phù hợp. Nội dung phải củng cố lựa chọn bằng thông tin chính xác về thương hiệu, đặc điểm nổi bật, các dòng đang có sản phẩm trong danh mục và cách chọn theo nhu cầu.
